...
def list_directory(root_dir, baseurl):
    ...
    <head>
        <meta charset='UTF-8'>
        <title>查看文件</title>
        <script src="/static/lyynd/dict/loadfont.js" type="text/javascript"></script>
        <link rel="stylesheet" href="/static/common/mouse/mouse.css">
        <link rel="stylesheet" href="/static/lyynd/dict/dict.css">
    ...
    <body>
        ...
        <p><a href="/disk/upload">点击返回</a></p>
        <div class="search-container">
        <form action="/disk/search/" method="GET">
    ...
    <script src="/static/common/mouse/mouse.js" type="text/javascript"></script>
    </div>
    </body>
    </html>
    """
    ...
    # 将生成的 HTML 写入文件
    with open(f"static\lyynd\dict\dict.html", 'w', encoding='utf-8') as f:
        f.write(html_page)
